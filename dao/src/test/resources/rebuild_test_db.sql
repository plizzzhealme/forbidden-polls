...
-- -----------------------------------------------------
-- Schema forbidden_polls_test
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema forbidden_polls_test
-- -----------------------------------------------------
DROP DATABASE IF EXISTS forbidden_polls_test;
CREATE SCHEMA IF NOT EXISTS `forbidden_polls_test` DEFAULT CHARACTER SET utf8;
USE `forbidden_polls_test`;

-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`categories`
(
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`countries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`countries`
(
    `id`       INT         NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`option_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`option_types`
(
    `id`   INT         NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`surveys`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`surveys`
(
    `id`            INT          NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_surveys_categories1`
        FOREIGN KEY (`category_id`)
            REFERENCES `forbidden_polls_test`.`categories` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`questions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`questions`
(
    `id`             INT          NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_question_surveys1`
        FOREIGN KEY (`survey_id`)
            REFERENCES `forbidden_polls_test`.`surveys` (`id`),
    CONSTRAINT `fk_questions_option_types1`
        FOREIGN KEY (`option_type_id`)
            REFERENCES `forbidden_polls_test`.`option_types` (`id`)
)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`options`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`options`
(
    `id`           INT          NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_possible_answers_questions1`
        FOREIGN KEY (`question_id`)
            REFERENCES `forbidden_polls_test`.`questions` (`id`)
)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`user_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`user_roles`
(
    `id`   INT         NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(45) NOT NULL,
    PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`genders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`genders`
(
    `id`   INT         NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(45) NOT NULL,
    PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`users`
(
    `id`                INT          NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_users_countries1`
        FOREIGN KEY (`country_id`)
            REFERENCES `forbidden_polls_test`.`countries` (`id`),
    CONSTRAINT `fk_users_user_roles1`
        FOREIGN KEY (`user_role_id`)
            REFERENCES `forbidden_polls_test`.`user_roles` (`id`),
    CONSTRAINT `fk_users_gender1`
        FOREIGN KEY (`gender_id`)
            REFERENCES `forbidden_polls_test`.`genders` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`passed_surveys`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`passed_surveys`
(
    `id`              INT      NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_passed_surveys_users1`
        FOREIGN KEY (`user_id`)
            REFERENCES `forbidden_polls_test`.`users` (`id`)
)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `forbidden_polls_test`.`picked_options`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `forbidden_polls_test`.`picked_options`
(
    `id`          INT          NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_picked_options_options1`
        FOREIGN KEY (`option_id`)
            REFERENCES `forbidden_polls_test`.`options` (`id`),
...
START TRANSACTION;
USE `forbidden_polls_test`;
INSERT INTO `forbidden_polls_test`.`option_types` (`id`, `type`)
...
START TRANSACTION;
USE `forbidden_polls_test`;
INSERT INTO `forbidden_polls_test`.`user_roles` (`id`, `name`)
...
START TRANSACTION;
USE `forbidden_polls_test`;
INSERT INTO `forbidden_polls_test`.`genders` (`id`, `name`)
...
INSERT INTO forbidden_polls_test.users (name, email, hashed_password, registration_date, birthday, user_role_id,
                                        country_id,
                                        gender_id)
...
INSERT INTO forbidden_polls_test.categories (name)
VALUES ('politics');
...
-- add polls
START TRANSACTION;
INSERT INTO forbidden_polls_test.surveys (name, creation_date, description, instructions, image_url, category_id)
VALUES ('Bad habits', '2022-01-05 11:27:52', 'Tell about your habits.', 'Just answer yes or no.', null, 2);

INSERT INTO forbidden_polls_test.questions (index_number, body, image_url, description, survey_id, option_type_id)
VALUES (1, 'Do you smoke?', null, null, 1, 1);

INSERT INTO forbidden_polls_test.options (index_number, body, question_id)
VALUES (1, 'yes', 1);
...
INSERT INTO forbidden_polls_test.surveys (id, name, creation_date, description, instructions, image_url, category_id)
VALUES (6, 'Последствия ковид-19', '2022-01-05 11:27:52', 'Расскажите', 'Выберите', null, 2);

INSERT INTO forbidden_polls_test.questions (id, index_number, body, image_url, description, survey_id, option_type_id)
