...
<form action="${Util.CONTROLLER}" method="post" accept-charset="UTF-8">
    ...
    <div class="grid-container-1">
        ...
        <div class="grid-item">
            <select class="classic" id="gender" name="${Util.USER_GENDER}">
        ...
        <div class="grid-item"><label for="country">${country}:</label></div>
        <div class="grid-item">
            <select class="classic" id="country" name="${Util.USER_COUNTRY}">
